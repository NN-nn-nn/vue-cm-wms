...
const validatorPhone = /^1([38]\d|4[5679]|5[0-35-9]|6[56]|7[01345678]|9[0126789])\d{8}$/

// 手机 + 固话
const validatorTel = /^(0\d{2}-\d{8}(-\d{1,4})?)|(0\d{3}-\d{7,8}(-\d{1,4})?)$|^1([38]\d|4[5679]|5[0-35-9]|6[56]|7[01345678]|9[0126789])\d{8}$/

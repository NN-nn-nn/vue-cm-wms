  ...
  <div class="page-container">
    ...
    <div class="content-container">
      <el-table v-loading="tableLoading" :data="tableData" max-height="700" style="width: 100%" border stripe>
        ...
        <el-table-column prop="typeName" label="退料总额(万元)" align="center">
...
<script>
import { fetchProjectOutboundReturn as fetchList } from '@/api/project'
export default {
  name: 'OutboundReturnSummaryComponent',
  props: {
    visible: {
      type: Boolean,
      default: false
  ...
  methods: {
    getList: function() {
      ...
      fetchList(this.listQuery).then(({ data, code, message }) => {
        ...
        this.tableLoading = false
        this.$message({ message: '获取项目退料汇总列表失败', type: 'error' })
      })
    },
    // 搜索界面
    handleFilter() {

    ...
    <div class="content-container">
      ...
      >
        ...
        <el-table-column label="物料类别" align="center">
          ...
          <el-table-column prop="kind" label="种类" align="center" width="120">
            <template slot-scope="scope">
          ...
          <el-table-column prop="material" label="材质" align="center" width="120">
            <template slot-scope="scope">
        ...
        <el-table-column label="规格" align="center">
          <el-table-column prop="specification" label="规格" align="center" width="120">
            <template slot-scope="scope">
              ...
              <el-input v-else v-model="scope.row.specification" placeholder="" />
            </template>
          </el-table-column>
          <el-table-column prop="long" label="长度(m)" align="center" width="120">
            <template slot-scope="scope">

<template>
  ...
  <div class="page-container in-warehouse-verify-index">
    ...
    >
      ...
      <SteelPlate v-if="currentInbound.formType === MATERIAL_BASE_TYPE.STEEL_PLATE.index" :detail-id="currentInbound.id" :is-verify="true" @closeEvent="detailVisible = false" @refreshEvent="refreshInfo" />
      ...
      <StripSteel v-if="currentInbound.formType === MATERIAL_BASE_TYPE.STRIP_STEEL.index" :detail-id="currentInbound.id" :is-verify="true" @closeEvent="detailVisible = false" @refreshEvent="refreshInfo" />
